...
- **磁化/Br（真實）**：Materials Project DFT（97 FM 化合物，需免費 API key）→ 真實 Br
  baseline（GBR, CV R²=0.56, MAE 0.33T；見 `docs/BR_CALIBRATION.md`）。
...
| ΔS_M / w | 🟡 | 文獻 ±12% |
| Br | 🟡🟢 | 真實 MP 訓練 GBR R²=0.56、MAE 0.33T（vs 合成 0.006）|
| 整機 η | 🟡 | 對標真實原型 ~2× 內 |
| 整機絕對 P/V | 🔴 | 理想化上界，~10× 高 |
