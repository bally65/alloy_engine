...
### Recent Analysis (2026-05-03)

- delta_M boundary explored: model limit **0.232 T** (7-sweep threshold experiment)
- Bottleneck identified: Br surrogate underestimation (−0.3 to −1.6 T vs. literature)
- v5.0 baseline 0.20 T confirmed as Pareto-optimal (post-hoc validation)
- See `analysis/delta_m_boundary/STATUS.md` for full findings and v5.1 recommendations
